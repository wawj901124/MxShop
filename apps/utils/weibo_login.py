...
def get_auth_url():
    ...
    redirect_url = "http://127.0.0.1:9000/complete/weibo/"   #配置为本地服务器域名
...
def get_access_token(code="971408f0569897d6ec44a227857335fe"):
    ...
    re_dict = requests.post(access_token_url,data={
        "client_id":237999617,
        "client_secret": "2c60b652a3a0c649d1bb122ab8bb86a24",
        "grant_type": "authorization_code",   #固定值
        "code": code,
        "redirect_url": "http://127.0.0.1:9000/complete/weibo/",
    })
    pass
